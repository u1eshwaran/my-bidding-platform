      ...
      <div className="marketplace-container">
        <div className="mb-8">
          ...
          <p className="text-gray-600">
            Track your offers and complete purchases
          </p>
        </div>
        ...
        {userNegotiations.length > 0 ? (
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {filteredNegotiations.map(negotiation => {
              ...
              return (
                <Link 
                  key={negotiation.id} 
                  to={`/buyer/negotiations/${negotiation.id}`}
                >
                    ...
                    <CardContent>
                      <div className="space-y-2">
                        <div className="flex justify-between items-center">
                          <span className="text-sm text-gray-500">Seller's Price</span>
          ...
          <div className="text-center py-16 bg-gray-50 rounded-lg border">
            ...
            <p className="text-gray-500 mb-6">
              You haven't started negotiating on any products
            </p>
            <Link to="/products">
              <Button>
                Browse Products
